...
install_xcframework "${PODS_ROOT}/hermes-engine/destroot/Library/Frameworks/universal/hermes.xcframework" "hermes" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
